...
export const metadata: Metadata = {
  title: "End User License Agreement — Opinionly",
  description:
    "Terms governing your installation and use of the Opinionly mobile application.",
};

export default function EulaPage() {
  return (
    <LegalPage title="End User License Agreement" lastUpdated="May 4, 2026">
      <p>
        Opinionly is licensed to You (End-User) by <strong>Opinionly LLC</strong>,
        located at Michigan, United States (&ldquo;<strong>Licensor</strong>
        &rdquo;), for use only under the terms of this License Agreement.
      </p>
      <p>
        By downloading the Licensed Application from Apple&rsquo;s software
        distribution platform (&ldquo;App Store&rdquo;) and Google&rsquo;s
        software distribution platform (&ldquo;Play Store&rdquo;), and any
      ...
      <p>
        ...
        Opinionly LLC, not the Services, is solely responsible for the
      ...
      <p>
        ...
        (&ldquo;<strong>Usage Rules</strong>&rdquo;). Opinionly LLC
      ...
      <p>
        Opinionly, when purchased or downloaded through the Services, is
        ...
        You. Opinionly is to be used on devices that operate with
        Apple&rsquo;s operating systems (&ldquo;iOS&rdquo; and &ldquo;Mac
        OS&rdquo;) or Google&rsquo;s operating system (&ldquo;Android&rdquo;).
      </p>
      ...
      <p>
        <strong>Opinionly</strong> (&ldquo;<strong>Licensed Application</strong>
        &rdquo;) is a piece of software created to help individuals receive
        anonymous feedback from their peers, fostering personal and
        professional growth in a constructive and supportive manner. The app
        leverages AI to filter and moderate feedback, ensuring that it
        remains positive and actionable, contributing to a more supportive
        community culture. It is customized for iOS and Android mobile
        devices (&ldquo;<strong>Devices</strong>&rdquo;).
      </p>
      <p>
        ...
        such laws, you may not use this Licensed Application. You may not use
        the Licensed Application in a way that would violate the
      ...
      <p>
        ...
        with Opinionly LLC&rsquo;s prior written consent), sell, rent, lend,
      ...
      <p>
        ...
        Licensed Application, or any part thereof (except with Opinionly
        LLC&rsquo;s prior written consent).
      </p>
      <p>
      ...
      <p>
        ...
        Licensed Application satisfies the technical specifications
        mentioned above.
      </p>
      <p>
      ...
      <p>
        4.2 Opinionly LLC and the End-User acknowledge that the Services
      ...
      <p>
        ...
        information, and that Licensor&rsquo;s use of such material and
        information is subject to Your legal agreements with Licensor and
        Licensor&rsquo;s privacy policy at:{" "}
        <a href="/privacy">https://opinionly.io/privacy</a>.
      </p>
      <p>
      ...
      <p>
        ...
        information or other material (collectively, &ldquo;
        <strong>Contributions</strong>&rdquo;). Contributions may be viewable
        by other users of the Licensed Application and through third-party
        websites or applications. As such, any Contributions you transmit
      ...
      <p>
        ...
        broadcast, retitle, archive, store, cache, publicly display,
        ...
        otherwise, and to prepare derivative works of, or incorporate in
        other works, such as Contributions, and grant and authorize
      ...
      <h2>8. Liability</h2>
      <p>
        8.1 Licensor&rsquo;s responsibility in the case of violation of
      ...
      <p>
        ...
        there are any other reasons outside of Opinionly LLC&rsquo;s sphere
      ...
      <p>
        ...
        after installing it and notify Opinionly LLC about issues discovered
      ...
      <p>
        ...
        Opinionly LLC reserves a choice to remedy the situation either by
      ...
      <p>
        Opinionly LLC and the End-User acknowledge that Opinionly LLC, and
      ...
      <p>
        ...
        by the US Government as a &ldquo;terrorist supporting&rdquo; country;
      ...
      <p>
        ...
        <br />
        <a href="mailto:info@theshareon.com">info@theshareon.com</a>
      </p>

      <h2>13. Termination</h2>
      <p>
        The license is valid until terminated by Opinionly LLC or by You.
        Your rights under this license will terminate automatically and
        without notice from Opinionly LLC if You fail to adhere to any
      ...
      <p>
        Opinionly LLC represents and warrants that Opinionly LLC will comply
        with applicable third-party terms of agreement when using Licensed
        Application.
      </p>
      <p>
        In Accordance with Section 9 of the &ldquo;Instructions for Minimum
        Terms of Developer&rsquo;s End-User License Agreement,&rdquo; both
        Apple and Google and their subsidiaries shall be third-party
        beneficiaries of this End User License Agreement and &mdash; upon
      ...
      <p>
        Opinionly LLC and the End-User acknowledge that, in the event of any
        third-party claim that the Licensed Application or the
        End-User&rsquo;s possession and use of that Licensed Application
        infringes on the third party&rsquo;s intellectual property rights,
        Opinionly LLC, and not the Services, will be solely responsible for
      ...
      <p>
        ...
        <strong>Michigan</strong> excluding its conflicts of law rules.
      </p>
