...
export const metadata: Metadata = {
  title: "Privacy Policy — Opinionly",
  description:
    "How Opinionly LLC collects, uses, and shares your personal information.",
};
...
export default function PrivacyPolicyPage() {
  return (
    <LegalPage title="Privacy Policy" lastUpdated="May 4, 2026">
      <p>
        This Privacy Notice for <strong>Opinionly LLC</strong> (&ldquo;
        ...
        <strong>process</strong>&rdquo;) your personal information when you
        use our services (&ldquo;<strong>Services</strong>&rdquo;), including
        when you:
      </p>
      <ul>
        <li>
          Download and use our mobile application (Opinionly), or any other
          application of ours that links to this Privacy Notice
        </li>
        <li>
          Use Opinionly. Opinionly is a mobile app designed to help
          individuals receive anonymous feedback from their peers, fostering
          personal and professional growth in a constructive and supportive
          manner. The app leverages AI to filter and moderate feedback,
          ensuring that it remains positive and actionable. Each piece of
          feedback is reconstructed, providing users with clear and concise
          insights that support their growth objectives. Initially targeted
          towards MBA students and professional environments, Opinionly aims
          to enhance communication, improve self-awareness, and contribute to
          a more supportive community culture.
        </li>
        <li>
      ...
      <p>
        ...
        <a href="https://opinionly.io">https://opinionly.io</a>, or by
      ...
      <p>
        ...
        information about you from your social media provider, as described
        in the section called &ldquo;How Do We Handle Your Social
        Logins?&rdquo; below.
      </p>
      <p>
      ...
      <ul>
        <li>
          ...
          mobile device, your mobile device&rsquo;s operating system or
          platform, the type of mobile device you use, your mobile
          device&rsquo;s unique device ID, and information about the features
      ...
      <p>
        ...
        by submitting a request as described below under section &ldquo;Do
        United States Residents Have Specific Privacy Rights?&rdquo;
      </p>
      <p>
      ...
      <p>
        ...
        (&ldquo;AI Service Providers&rdquo;), including OpenAI and Google
        ...
        outlined in &ldquo;What Legal Bases Do We Rely On to Process Your
        Personal Information?&rdquo; You must not use the AI Products in any
      ...
      <p>
        ...
        whom we may share your personal information (see &ldquo;When and With
        Whom Do We Share Your Personal Information?&rdquo; above), in and
        other countries.
      </p>
      <p>
      ...
      <p>
        ...
        three (3) months past the termination of the user&rsquo;s account.
      </p>
      <p>
      ...
      <p>
        ...
        by using the contact details provided in the section &ldquo;How Can
        You Contact Us About This Notice?&rdquo; below.
      </p>
      <p>
      ...
      <p>
        ...
        information, please see our <a href="/cookies">Cookie Notice</a>.
      </p>
      <p>
      ...
      <p>
        <em>
          ...
          or Virginia, you may have the right to request access to and
      ...
      <ul>
        ...
        <li>
          ...
          under California&rsquo;s privacy law), the sale of personal data,
      ...
      <p>
        ...
        <a href="https://opinionly.io">https://opinionly.io</a>, by emailing
        us at <a href="mailto:info@theshareon.com">info@theshareon.com</a>,
      ...
      <p>
        ...
        emailing us at{" "}
        <a href="mailto:info@theshareon.com">info@theshareon.com</a>. We will
      ...
      <p>
        ...
        at <a href="mailto:info@theshareon.com">info@theshareon.com</a> or
      ...
      <p>
        ...
        <a href="https://opinionly.io">https://opinionly.io</a>.
      </p>
    </LegalPage>
  );
}
