...
export const metadata: Metadata = {
  title: "Terms of Service — Opinionly",
  description:
    "The legal agreement between you and Opinionly LLC governing your use of the Services.",
};
...
export default function TermsOfServicePage() {
  return (
    <LegalPage title="Terms of Service" lastUpdated="May 4, 2026">
      ...
      <p>
        We are <strong>Opinionly LLC</strong> (&ldquo;<strong>Company</strong>
        ,&rdquo; &ldquo;<strong>we</strong>,&rdquo; &ldquo;<strong>us</strong>
        ,&rdquo; &ldquo;<strong>our</strong>&rdquo;).
      </p>
      <p>
        We operate the mobile application <strong>Opinionly</strong> (the
        &ldquo;<strong>App</strong>&rdquo;), as well as any other related
        products and services that refer or link to these legal terms (the
        &ldquo;<strong>Legal Terms</strong>&rdquo;) (collectively, the &ldquo;
        <strong>Services</strong>&rdquo;).
      </p>
      <p>
        You can contact us by email at{" "}
        <a href="mailto:info@theshareon.com">info@theshareon.com</a> or by
        mail to MI, United States.
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity (&ldquo;
        <strong>you</strong>&rdquo;), and Opinionly LLC, concerning your
      ...
      <p>
        ...
        upon the date specified in the notice, except if the changes apply to
        new functionality, security updates, and bug fixes, in which case the
        ...
        may terminate Services as per the section &ldquo;Term and
        Termination.&rdquo;
      </p>
      <p>
      ...
      <p>
        ...
        graphics in the Services (collectively, the &ldquo;Content&rdquo;),
      ...
      <p>
        ...
        <a href="mailto:info@theshareon.com">info@theshareon.com</a>. If we
      ...
      <p>
        ...
        your order. We reserve the right to correct any errors or mistakes
      ...
      <ul>
        ...
        <li>
          ...
          graphics interchange formats (&ldquo;gifs&rdquo;), 1×1 pixels, web
      ...
      <p>
        ...
        the Apple Store or Google Play (each an &ldquo;App Distributor&rdquo;)
        ...
        applicable App Distributor&rsquo;s terms of service; (2) we are
        ...
        the US government as a &ldquo;terrorist supporting&rdquo; country and
      ...
      <p>
        ...
        from the Services or otherwise disable all files and content that
        are excessive in size or are in any way burdensome to our systems;
        and (5) otherwise manage the Services in a manner designed to protect
      ...
      <p>
        ...
        State of Michigan, without regard to its conflict of law principles.
      </p>
      ...
      <p>
        ...
        Consumer Related Disputes (&ldquo;AAA Consumer Rules&rdquo;), both of
        which are available at the American Arbitration Association (AAA)
        ...
        the arbitration will take place in Washtenaw, Michigan. Except as
      ...
      <p>
        ...
        state and federal courts located in Washtenaw, Michigan, and the
      ...
      <p>
        ...
        COMPLETENESS OF THE SERVICES&rsquo; CONTENT OR THE CONTENT OF ANY
