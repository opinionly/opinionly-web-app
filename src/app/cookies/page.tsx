...
export const metadata: Metadata = {
  title: "Cookie Policy — Opinionly",
  description: "How Opinionly LLC uses cookies and similar technologies.",
};

export default function CookiePolicyPage() {
  return (
    <LegalPage title="Cookie Policy" lastUpdated="May 4, 2026">
      <p>
        This Cookie Policy explains how Opinionly LLC (&ldquo;
        <strong>Company</strong>,&rdquo; &ldquo;<strong>we</strong>,&rdquo;{" "}
        &ldquo;<strong>us</strong>,&rdquo; and &ldquo;<strong>our</strong>
        &rdquo;) uses cookies and similar technologies to recognize you when
        you visit our website at{" "}
        <a href="https://opinionly.io">https://opinionly.io</a> (&ldquo;
        <strong>Website</strong>&rdquo;). It explains what these technologies
      ...
      <p>
        Cookies set by the website owner (in this case, Opinionly LLC) are
        ...
        cookies can recognize your computer both when it visits the website
      ...
      <p>
        ...
        browser&rsquo;s help menu for more information. The following is
      ...
      <p>
        Websites may also use so-called &ldquo;Flash Cookies&rdquo; (also
        known as Local Shared Objects or &ldquo;LSOs&rdquo;) to, among other
        things, collect and store information about your use of our services,
      ...
      <p>
        ...
        existing Flash Cookies (referred to &ldquo;information&rdquo; on the
